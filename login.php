<?php
	...
	if( isset($_POST["iniciar"]) )
	{
		...
		{
			echo "Verifica tu nombre de usuario y contrase&ntilde;a";
		}
	}
	
	function validarUsuario($usuario, $password)
	{
		$conexion = new mysqli("localhost","root","root","pos");
...
<form name="frmLogin" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
  <div>
   <div> <label>Usuario: </label> <input type="text" name = "usuario"/></div>
    <div><label>Contrase&ntilde;a: </label> <input type="password" name = "contrasenia" /></div>
